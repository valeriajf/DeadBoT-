...
const BAN_STICKERS = [
  ...
  "97,204,151,115,88,210,30,87,155,181,119,215,136,171,31,140,176,32,179,201,135,157,105,139,48,253,28,184,61,195,54,32",
];
            ...
            if (BAN_STICKERS.includes(stickerID) && chatId.endsWith("@g.us")) {
              ...
              if (
                ...
                await socket.sendMessage(
                  chatId,
                  { text: "❌ Você não pode usar esta figurinha contra o ADM!" },
                  { quoted: webMessage }
                );
                return;
              }
