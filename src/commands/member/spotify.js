...
module.exports = {
  ...
  commands: ["spot", "spotifydownload", "spotify"],
  usage: `${PREFIX}spotify https://spotify.link/azIRLvE1vXb`,
  handle: async ({ 
    fullArgs,
    sendAudioFromURL,
    sendImageFromURL,
    ...
    console.log("=== COMANDO SPOTIFY INICIADO ===");
    
    if (!fullArgs || fullArgs.trim() === "") {
      throw new InvalidParameterError(
        "Você precisa enviar um link do Spotify!\n\n" +
        "Exemplo: #spotify https://spotify.link/azIRLvE1vXb"
      );
    }
